...
for file in file_name:
    ...
    results.append([file, query_point ,execution_time])
...
with open('execution_times_kdtree.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(["File Name", "Query Point", "Execution Time (seconds)"])
